...
export class JobseekerService {
  async insertEmployer(
    employerDetails: CreateEmployerDto,
  ...
  async updateEmployer(
    employerDetails: UpdateEmployerDto,
  ): Promise<EmployerEntity> {
    const {
      id,
      first_name,
  ...
  async insertFreelancer(
    freelancerDetails: CreateFreelancerDto,
  ...
  async updateFreelancer(
    freelancerDetails: UpdateFreelancerDto,
  ): Promise<FreelancerEntity> {
    const {
      id,
      first_name,
  ...
  async insertProject(
    projectDetails: CreateProjectDto,
  ): Promise<ProjectEntity> {
